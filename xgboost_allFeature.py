...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 10:57:27 2019
...
X_train = pd.read_csv('../data/X_train_xgboost_allFeatures.csv')
X_test = pd.read_csv('../data/X_test_xgboost_allFeatures.csv')
y_train = pd.read_csv('../data/y_train_xgboost_allFeatures.csv')
y_test = pd.read_csv('../data/y_test_xgboost_allFeatures.csv')
...
best_gamma = 0.4
param_test4 = {
        'gamma': [best_gamma-0.1,best_gamma,best_gamma+0.1]
    }
"""
...
"""
#clf.set_params(subsample = 0.9,colsample_bytree = 0.95)
"""
param_test7 = {
...
"""
#clf.set_params(reg_alpha = 1,reg_lambda = 1e-5)

"""
gsearch = GridSearchCV(clf, param_grid=param_test7, scoring='neg_mean_squared_error',n_jobs=3, cv=3)
