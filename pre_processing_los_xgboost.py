...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug  9 09:55:55 2019
...
X_train.to_csv('../data/X_train_los_xgboost_allFeatures.csv',index=False)
X_test.to_csv('../data/X_test_los_xgboost_allFeatures.csv',index=False)
y_train.to_csv('../data/y_train_los_xgboost_allFeatures.csv',index=False)
y_test.to_csv('../data/y_test_los_xgboost_allFeatures.csv',index=False)