...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 16:53:55 2019
...
X_train.to_csv('../data/X_train_xgboost_allFeatures.csv',index=False)
X_test.to_csv('../data/X_test_xgboost_allFeatures.csv',index=False)
y_train.to_csv('../data/y_train_xgboost_allFeatures.csv',index=False)
y_test.to_csv('../data/y_test_xgboost_allFeatures.csv',index=False)
